...
BOT_USERNAME = getenv("BOT_USERNAME" , "ShubhuMusicBot")
BOT_NAME = getenv("BOT_NAME" , "˹𝑺𝒉𝒖𝒃𝒉𝒖 𝑴𝒖𝒔𝒊𝒄 𝑩𝒐𝒕")
ASSUSERNAME = getenv("ASSUSERNAME" , "Assistant4Shubhu")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Yewsdhi/MYLOVEJAAN",)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ll_ROYAL_ABOUT_ll")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", SUPPORT_CHAT)
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT", "True")
AUTO_LEAVE_ASSISTANT_TIME = int(getenv("ASSISTANT_LEAVE_TIME", "30000"))
