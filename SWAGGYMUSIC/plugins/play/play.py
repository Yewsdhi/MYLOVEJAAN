...
import config
from SWAGGYMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
from SWAGGYMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
@app.on_callback_query(filters.regex("SwaggyAdmin") & ~BANNED_USERS)
async def swaggy_admin_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("SwaggyPlaylists") & ~BANNED_USERS)
@languageCB
