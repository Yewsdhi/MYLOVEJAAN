...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("ㅤ- BABA ", url="https://t.me/BABA_OWNERR")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/Anjali_music_support"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/messo_network"),
        ],
        [
